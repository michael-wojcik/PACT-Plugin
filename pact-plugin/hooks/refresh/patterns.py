...
PACT_AGENT_PATTERN = re.compile(r"pact-(preparer|architect|backend-coder|frontend-coder|database-engineer|devops-engineer|n8n|security-engineer|qa-engineer|test-engineer|memory-agent)")
